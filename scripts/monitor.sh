...
function change_screen_to() {
  case $1 in
  dock)
     xrandr --output eDP1 --primary --mode 1920x1080 --pos 1663x1080 --rotate normal --output DP1 --off --output DP2 --off --output DP2-1 --off --output DP2-2 --mode 2560x1080 --pos 0x0 --rotate normal --output DP2-3 --mode 2560x1080 --pos 2560x0 --rotate normal --output HDMI1 --off --output HDMI2 --off --output VIRTUAL1 --off
      ;;
  laptop)
